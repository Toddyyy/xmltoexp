...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the clean-outer 1D-CNN baseline (no dilation) with the weighted top-down target protocol."
    )
...
def main() -> None:
    ...
    for level_label in args.targets:
        ...
        print(
            f"cnn {level_label} | p={union_metrics['union_precision']:.4f} | "
