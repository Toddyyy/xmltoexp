...
MAZURKA_SCRIPT = EXPERIMENTS / "run_mazurkabl_l2plus_sqrtmass_branchwise_cnn.py"
ASAP_SCRIPT = EXPERIMENTS / "run_asap30_l2plus_sqrtmass_baseline_branchwise.py"
OUT_DIR = RESULTS / "combined_l2plus_sqrtmass_baseline_branchwise"
